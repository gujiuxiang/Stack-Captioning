...
class DataLoader_ft():
    def reset_iterator(self, split):
        ...
        self._prefetch_process[split] = BlobFetcher_ft(split, self)
    ...
    def __init__(self, opt):
        ...
        def cleanup():
            print('Terminating BlobFetcher_ft')
            for split in self.iterators.keys():
                self._prefetch_process[split].terminate()
                self._prefetch_process[split].join()
    ...
    def get_batch_ft(self, split, batch_size=None, seq_per_img=None):
